...
| --- | --- | --- |
| Ask GroupMe who's available | `ask` | `📢 New gig request received! Who can join us for:` + gig, date · time · place, a sample reply, the signed gig link, and a 📅 add-to-calendar link that opens the Apple / Google / Outlook chooser |
