...
const MEMBER_COLS = `e.id, e.title, e.status, e.event_type, e.event_date, e.start_time, e.end_time, e.call_time,
  e.venue, e.address, e.city, e.dancers_needed, e.pay, e.details, e.rehearsals, e.published_at, e.confirmed_at, e.updated_at, e.website`;
...
export async function rosterFor(eventId) {
  const families = await sql(
    `SELECT f.id, f.name, f.email, f.phone,
